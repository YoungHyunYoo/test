...
{
printf("\n%s CapturePluginProxy::AudioChunkCallBack : %d\n",capturePort.c_str(),chunkRef.use_count());
...
//printf("___CaptureEventCallback2\n");
			...
			{
//printf("___CaptureEventCallback3\n");
		...
		{
//printf("___CaptureEventCallback4\n");
			// find the right port and give it the event
			CapturePortRef portRef = CapturePortsSingleton::instance()->AddAndReturnPort(capturePort);
	...
	{
//printf("___CaptureEventCallback5\n");
		// find the right port and give it the event
		CapturePortRef portRef = CapturePortsSingleton::instance()->AddAndReturnPort(capturePort);
//printf("___%s\n",portRef->GetId().c_str());
		portRef->AddCaptureEvent(eventRef);
	}
//printf("__CaptureEventCallBack End\n");
}
