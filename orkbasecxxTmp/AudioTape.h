...
private:
	...
	int m_sttPopCount;
	int m_sttHighMark;
	unsigned int m_sttChunkQueueDataSize;
	bool m_sttChunkQueueErrorReported;
	int m_sttBytesWritten;
	bool m_sttReadyForBatchProcessing;
	...
	AudioFileRef m_audioSttFileRef;
	ACE_Thread_Mutex m_mutex;
	bool m_shouldStop;
	bool m_sttShouldStop;
