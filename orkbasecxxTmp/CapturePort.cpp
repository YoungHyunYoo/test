...
//printf("__FilterAudioChunk start\n");
...
void CapturePort::FilterCaptureEvent(CaptureEventRef& eventRef)
{
	// Iterate through all filters
	std::list<FilterRef>::iterator it;
//printf("__FilterCaptureEvent start\n");
	for(it = m_filters.begin(); it != m_filters.end(); it++)
	{
//printf("__FilterCaptureEvnet loop\n");
		FilterRef filter = *it;
		filter->CaptureEventIn(eventRef);
		filter->CaptureEventOut(eventRef);
	}
//printf("__FilterCaptureEvent end\n");
}
...
{
printf("___CapturePort::ReportEventBacklog start\n");
...
{
//printf("___CapturePort::AddAudioChunk start\n");
	...
	{
//printf("___CapturePort::AddAudioChunk 1\n");
	...
	{
//printf("___CapturePort::AddAudioChunk 2\n");
	...
	{
printf("CapturePort::AddAudioChunk %d\n",chunkRef.use_count());
		m_audioTapeRef->AddAudioChunk(chunkRef);

		if(CONFIG.m_sttEnable==true){
			//AudioTapeRef m_sttAudioTapeRef = m_audioTapeRef;
			//SttProcessing::GetInstance()->AddAudioTape(m_sttAudioTapeRef);
			SttProcessing::GetInstance()->AddAudioTape(m_audioTapeRef);
		}
...
{
//printf("___CapturePort::AddCaptureEvent start\n");
//printf("___eventRef->m_type : %d\n",eventRef->m_type);
...
//printf("___CapturePort::AddCaptureEvent1\n");
		m_capturing = true;
		if (audioTapeRef.get())
		{

//printf("___CapturePort::AddCaptureEvent2\n");
...
//printf("___CapturePort::AddCaptureEvent3\n");
	if (!audioTapeRef.get())
	{
//printf("___CapturePort::AddCaptureEvent4\n");
		if(!CONFIG.m_vad && !CONFIG.m_audioSegmentation)
		{
//printf("___CapturePort::AddCaptureEvent5\n");
	...
	{
//printf("___CapturePort::AddCaptureEvent6\n");
		...
		{
//printf("___CapturePort::AddCaptureEvent7\n");
			m_capturing = false;
...
//printf("__ after 334\n");
		...
		{
//printf("___CapturePort::AddCaptureEvent8\n");
		...
		{
//printf("___CapturePort::AddCaptureEvent9\n");
			audioTapeRef->AddCaptureEvent(eventRef, true);
		...
		default:
//printf("___CapturePort::AddCaptureEvent10\n");
			audioTapeRef->AddCaptureEvent(eventRef, false);
		}
	}

//printf("___CapturePort::AddCaptureEvent End\n");
}
